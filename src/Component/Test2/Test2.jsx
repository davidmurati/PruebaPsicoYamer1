...
const preguntas = [
  {
    ...
    {
      texto: "55) Escriba los dos números que faltan a esta serie: 120, 100, 82, 66, x, 40, 30, x, 16, 12, 10",
      opciones: [
        "52 y 20",
        "52 y 22",
        "53 y 23",
...
const BARSIT = () => {
  ...
  // Nivel de estudios predeterminado
  const nivelEstudios = '6grado';
